...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400">
  ...
  <text x="150" y="205" text-anchor="middle" fill="white" font-family="Arial" font-size="12">
    토큰 업데이트
  </text>

  <rect x="250" y="160" width="100" height="80" rx="10" fill="#f472b6" />
  <text x="300" y="195" text-anchor="middle" fill="white" font-family="Arial" font-size="12">
    자동화
  </text>
  <text x="300" y="210" text-anchor="middle" fill="white" font-family="Arial" font-size="12">
    파이프라인
  </text>

  <path d="M400 200 L450 150 L500 150 L500 250 L450 250 Z" fill="#a855f7" />
  <text x="450" y="205" text-anchor="middle" fill="white" font-family="Arial" font-size="12">
    검토
  </text>

  <rect x="550" y="120" width="100" height="60" rx="10" fill="#2dd4bf" />
  <text x="600" y="155" text-anchor="middle" fill="white" font-family="Arial" font-size="11">
    스토리북
  </text>
  <text x="600" y="170" text-anchor="middle" fill="white" font-family="Arial" font-size="11">
    테스트
  </text>

  <rect x="550" y="220" width="100" height="60" rx="10" fill="#2dd4bf" />
  <text x="600" y="255" text-anchor="middle" fill="white" font-family="Arial" font-size="11">
    임시환경
  </text>
  <text x="600" y="270" text-anchor="middle" fill="white" font-family="Arial" font-size="11">
    테스트
  </text>
