...
import { formatDate } from '../lib/post.api';
        ...
        <CardContent className="p-4 h-full flex flex-col">
          <div className="space-y-3 flex-1">
            ...
            <div className="flex items-center justify-between text-xs text-muted-foreground">
              ...
              <span className="bg-muted px-2 py-1 rounded-md">{readingTime}</span>
            </div>
  ...
  return (
    <section className="space-y-6">
      <div className="text-center space-y-2">
        <h3 className="text-2xl font-bold text-foreground">🔗 연관 글</h3>
        <p className="text-sm text-muted-foreground">비슷한 주제의 다른 포스트들을 확인해보세요</p>
      </div>
