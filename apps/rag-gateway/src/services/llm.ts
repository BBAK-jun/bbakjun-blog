...
답변:`
  ...
  private detectIntent(query: string): QueryIntent {
    ...
    if (lowerQuery.includes('설명') || lowerQuery.includes('설명해') || lowerQuery.includes('explain')) {
      return 'explain'
    }
    if (lowerQuery.includes('예제') || lowerQuery.includes('예시') || lowerQuery.includes('example')) {
      return 'find_examples'
    }
    if (lowerQuery.includes('비교') || lowerQuery.includes('차이') || lowerQuery.includes('compare')) {
      return 'compare'
    }
    if (lowerQuery.includes('방법') || lowerQuery.includes('어떻게') || lowerQuery.includes('how to')) {
      return 'how_to'
    }
    if (lowerQuery.includes('문제') || lowerQuery.includes('에러') || lowerQuery.includes('오류') || lowerQuery.includes('troubleshoot')) {
      return 'troubleshoot'
    }
    if (lowerQuery.includes('최적') || lowerQuery.includes('추천') || lowerQuery.includes('best practice')) {
